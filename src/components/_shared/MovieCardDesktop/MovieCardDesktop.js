  ...
  return (
    <React.Fragment>
      ...
      >
        ...
        <div className="favorite-container"  className={`favorite-container ${cardFlipped ? "favorite-container-flipped" : ""}`}>
          <button onClick={addToFavorites}>
            {icon?<FontAwesomeIcon icon={solidHeart} style={{ color: "red" }} />:
